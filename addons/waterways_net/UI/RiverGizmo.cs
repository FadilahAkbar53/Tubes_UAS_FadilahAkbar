...
public partial class RiverGizmo : EditorNode3DGizmoPlugin
{
    ...
    private void DrawPath(EditorNode3DGizmo gizmo, Curve3D curve)
    {
        ...
        gizmo.AddLines(path.ToArray(), material);
    }
    ...
    private void DrawHandles(EditorNode3DGizmo gizmo, RiverManager river)
    {
        ...
        gizmo.AddHandles(handlesCenter.ToArray(), GetMaterial(GizmoMaterials.HandlesCenter, gizmo), new int[0]);
        gizmo.AddHandles(handlesControlPoints.ToArray(), GetMaterial(GizmoMaterials.HandlesControlPoints, gizmo), new int[0]);
        gizmo.AddHandles(handlesWidth.ToArray(), GetMaterial(GizmoMaterials.HandlesWidth, gizmo), new int[0]);

        gizmo.AddHandles(handlesCenter.ToArray(), GetMaterial(GizmoMaterials.HandlesCenterDepth, gizmo), new int[0]);
        gizmo.AddHandles(handlesControlPoints.ToArray(), GetMaterial(GizmoMaterials.HandlesControlPointsDepth, gizmo), new int[0]);
        gizmo.AddHandles(handlesWidth.ToArray(), GetMaterial(GizmoMaterials.HandlesWidthDepth, gizmo), new int[0]);
    }
